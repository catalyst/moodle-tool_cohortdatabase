...
if ($hassiteconfig) {
    ...
    $options = array('', "pdo", "pdo_mssql", "pdo_sqlsrv","access","ado_access", "ado", "ado_mssql", "borland_ibase", "csv", "db2", "fbsql", "firebird", "ibase", "informix72", "informix", "mssql", "mssql_n", "mssqlnative", "mysql", "mysqli", "mysqlt", "oci805", "oci8", "oci8po", "odbc", "odbc_mssql", "odbc_oracle", "oracle", "postgres64", "postgres7", "postgres", "proxy", "sqlanywhere", "sybase", "vfp");
    ...
    $settings->add(new admin_setting_configtext('tool_cohortdatabase/dbhost', get_string('dbhost', 'tool_cohortdatabase'), get_string('dbhost_desc', 'tool_cohortdatabase'), ''));
    ...
    $settings->add(new admin_setting_configtext('tool_cohortdatabase/minrecords', get_string('minrecords', 'tool_cohortdatabase'), get_string('minrecords_desc', 'tool_cohortdatabase'), 1));
    ...
    $settings->add(new admin_setting_heading('tool_cohortdatabase_createusers', get_string('settingscreateusers', 'tool_cohortdatabase'), ''));

    $options = array(0 => get_string('no'),
                     1  => get_string('yes'));
    $settings->add(new admin_setting_configselect('tool_cohortdatabase/createusers', get_string('settingscreateusers', 'tool_cohortdatabase'), get_string('settingscreateusers_desc', 'tool_cohortdatabase'), 0, $options));

    $settings->add(new admin_setting_configtext('tool_cohortdatabase/createusers_username', get_string('createusers_username', 'tool_cohortdatabase'), get_string('createusers_username_desc', 'tool_cohortdatabase'), ''));

    $settings->add(new admin_setting_configtext('tool_cohortdatabase/createusers_email', get_string('createusers_email', 'tool_cohortdatabase'), get_string('createusers_email_desc', 'tool_cohortdatabase'), ''));

    $settings->add(new admin_setting_configtext('tool_cohortdatabase/createusers_firstname', get_string('createusers_firstname', 'tool_cohortdatabase'), get_string('createusers_firstname_desc', 'tool_cohortdatabase'), ''));

    $settings->add(new admin_setting_configtext('tool_cohortdatabase/createusers_lastname', get_string('createusers_lastname', 'tool_cohortdatabase'), get_string('createusers_lastname_desc', 'tool_cohortdatabase'), ''));
    ...
    $settings->add(new admin_setting_configselect('tool_cohortdatabase/createusers_auth', get_string('createusers_auth', 'tool_cohortdatabase'), get_string('createusers_auth_desc', 'tool_cohortdatabase'), 'manual', $options));
